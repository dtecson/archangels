...
<!--                        <li><a class="twitter" href="http://twitter.com/morethanthemes" title="Follow Us on Twitter!"></a></li>-->
                        <li><a class="facebook" href="http://www.facebook.com/archangels.scenario.paintball.team" title="Join Us on Facebook!"></a></li>
    ...
    <div id="wrapper">
        ...
        <div class="container_12">
            ...
            <div class="grid_12">
                ...
                <a href="<?php print url('node/3'); ?>"><img src="<?php print base_path() . drupal_get_path('theme', 'bluemasters') . '/images/teampic.jpg'; ?>"></a>
                </div>
                <div class="slider-item-caption">Website coming soon</div>
                </li>
                <!-- EOF: slider-item -->
